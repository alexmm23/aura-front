  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Chatea con tus profesores y compañeros en tiempo real. Comunicación directa y efectiva dentro de AURA."
        />
        <meta
          name="keywords"
      ...
      <SafeAreaProvider>
        ...
        >
          {/* ✅ CAMBIO: ChatScreen ahora controla todo el contenido */}
          <ChatScreen
            userRole="student"
            ...
            screenTitle=""
            hideTitle={true}
            showCustomHeader={true} // ✅ NUEVA PROP
            customHeader={ // ✅ NUEVA PROP: Pasar el header como children
              <>
