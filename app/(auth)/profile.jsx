...
import { View, ScrollView, Image, StyleSheet, useWindowDimensions, TouchableOpacity } from "react-native";
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.iconRow}>
            <Image source={require("@/assets/images/classroom.png")} style={styles.icon} />
            <Image source={require("@/assets/images/moodle.png")} style={styles.icon} />
            <Image source={require("@/assets/images/teams.png")} style={styles.icon} />
          </View>
          ...
          <TouchableOpacity style={styles.button}>
            <AuraText style={styles.buttonText} text="Administrar Suscripción" />
          </TouchableOpacity>
